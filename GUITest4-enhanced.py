...
class MyWindow(tk.Tk):
    ...
    # create a Text widget
        ...
        self.txt.grid(row=0, column=0, columnspan=2, sticky=tk.E+tk.W+tk.N+tk.S, padx=2, pady=2)
   ...
   # create a Scrollbar and associate it with txt
        ...
        scrollb2.grid(row=1, column=0, columnspan=2, sticky=tk.E+tk.W)
        
        self.txt['xscrollcommand'] = scrollb2.set  
        
        self.path = tk.Entry(self, textvariable=self.pathVar)
        self.path.grid(row=2, column=0, sticky=tk.E+tk.W, padx=2, pady=2)
        
        self.path = tk.Button(self, text="load", command=self.loadFile)
        self.path.grid(row=2, column=1,  sticky=tk.W,padx=2, pady=2)
        self.setMenu()
    ...
    def loadFile(self): 
        ...
        try:
            ...
            self.txt.delete('1.0', tk.END)
            self.txt.insert(tk.END, f"Problem reading the file {fname}")        
